...
export async function POST() {
  try {
    ...
    logger.error("Error initiating Discord OAuth:", { error: error instanceof Error ? error.message : String(error) });
    return NextResponse.json(
...
export async function DELETE() {
  try {
    ...
    logger.error("Error disconnecting Discord:", { error: error instanceof Error ? error.message : String(error) });
    return NextResponse.json(
