      ...
      <HomeAnimations>
        ...
        <section className="pt-16 pb-10 md:pt-24 md:pb-14 lg:pt-32 lg:pb-16 px-4 relative">
          <div className="container mx-auto text-center max-w-5xl">
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-4 md:mb-6 animate-fade-up leading-tight" style={{ animationDelay: "0.1s" }}>
              ...
              and{" "}
              <span className="gradient-text">Buying Signals</span>
            </h1>
            ...
            <div className="text-center mb-10 md:mb-16">
              ...
              <TextReveal delay={0.1}>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4">
                  From noise to actionable insight in 3 steps
                </h2>
              </TextReveal>
            </div>
            ...
            <div className="grid sm:grid-cols-3 gap-6 md:gap-8">
              <AnimatedStepCard delay={0}>
                <StepCard
                  ...
                  description="Enter your brand, competitor, or niche keywords. Pick your platforms. Done in 30 seconds."
                />
              </AnimatedStepCard>
        ...
        <AnimatedSection className="py-16 md:py-24 px-4">
          <div className="container mx-auto">
            <div className="text-center mb-10 md:mb-16">
              <TextReveal>
                <Badge variant="outline" className="mb-3 md:mb-4">Product</Badge>
              </TextReveal>
              <TextReveal delay={0.1}>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4">
                  See it in action
          ...
          <div className="container mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-10 items-center mb-6">
              <AnimatedBadge delay={0.3}>
                <PlatformBadgeItem platform="x" name="X (Twitter)" color="text-gray-300" />
              </AnimatedBadge>
