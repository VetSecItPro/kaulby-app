...
export function ObservabilityTabs() {
  ...
  return (
    <div className="border-b">
      {/* A11Y-STRUCT-003: aria-label on nav landmark for screen-reader navigation. */}
      <nav aria-label="Observability sections" className="flex gap-1 -mb-px">
        {TABS.map((tab) => {
          ...
          return (
            <Link
              key={tab.href}
              href={tab.href}
              // A11Y-STRUCT-003: aria-current="page" identifies the active tab to screen readers.
