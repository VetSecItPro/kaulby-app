...
const alternatives = [
  {
    ...
    description: "*** was Reddit-only. Kaulby monitors 12 platforms with the same AI features.",
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Kaulby is the best *** alternative. It offers the same Reddit monitoring with AI analysis, plus 11 more platforms (Hacker News, Product Hunt, review sites). Unlike ***, Kaulby isn't dependent on a single platform's API.",
  },
  {
