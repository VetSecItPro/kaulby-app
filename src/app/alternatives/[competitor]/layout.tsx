...
const competitorMeta: Record<string, { name: string; description: string }> = {
  ...
  brand24: {
    name: "Brand24",
    description: "Compare Kaulby vs Brand24 for community monitoring. Kaulby offers 17 platforms, AI-powered insights, and startup-friendly pricing starting at $0.",
  },
  brandwatch: {
    name: "Brandwatch",
  ...
  sproutsocial: {
    name: "Sprout Social",
    description: "Looking for a Sprout Social alternative? Kaulby offers dedicated community monitoring with 17 platforms, AI analysis, and pricing that starts at $0.",
  },
  awario: {
    name: "Awario",
  ...
  syften: {
    name: "Syften",
    description: "Looking for a Syften alternative? Kaulby offers AI sentiment analysis, pain point detection, and 17 platforms vs Syften's limited coverage. Free tier available.",
  },
  gummysearch: {
    name: "GummySearch",
  ...
  redreach: {
    name: "RedReach",
    description: "Compare Kaulby vs RedReach for Reddit marketing. Kaulby monitors 17 platforms, offers AI reply suggestions, and includes a free tier. No Reddit-only limitation.",
  },
  subredditsignals: {
  ...
  f5bot: {
    name: "F5Bot",
    description: "Need more than F5Bot's basic alerts? Kaulby offers a dashboard, AI analysis, sentiment tracking, and 17 platforms. Free tier matches F5Bot's price.",
  },
};
...
export async function generateMetadata({ params }: LayoutProps): Promise<Metadata> {
  ...
  const meta = competitorMeta[competitor] || {
    ...
    description: `Compare Kaulby vs ${competitor} for community monitoring. Kaulby offers 17 platforms, AI-powered insights, and a free tier.`,
  };
