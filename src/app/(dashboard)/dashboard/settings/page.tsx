...
async function SettingsContent() {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "$39",
      period: "/month",
      description: "For solo founders and individual operators",
      features: [
        "10 monitors",
        "9 platforms",
        "Unlimited keywords per monitor",
        "Unlimited results",
        "90-day history",
    ...
    },
    {
      ...
      price: "$79",
      period: "/month",
      description: "For growing operators who need review-site coverage",
      features: [
        "Everything in Solo",
        "20 monitors",
        "12 platforms (+ G2, Yelp, Amazon Reviews)",
        "180-day history",
        "4-hour refresh cycle",
      ],
      current: subscriptionStatus === "scale",
      recommended: true,
    },
    {
      name: "Growth",
