  ...
  "social-listening-for-startups": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Kaulby monitors 16 platforms: Reddit, Hacker News, Product Hunt, Google Reviews, Trustpilot, App Store reviews, Play Store reviews, YouTube, G2, Yelp, and Amazon Reviews. These are the platforms where startups get discovered and discussed, unlike traditional social listening tools that focus on Twitter and Facebook.",
      },
      {
