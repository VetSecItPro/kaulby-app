...
export async function generateMetadata({
  ...
  const titles: Record<string, string> = {
    ...
    "brand-monitoring": "Brand Monitoring Tool - Track Mentions Across 12 Platforms | Kaulby",
  ...
  const descriptions: Record<string, string> = {
    ...
    "social-listening-for-startups": "Affordable social listening for startups. Monitor 12 platforms including Reddit, Hacker News, and review sites. Start free, no credit card required.",
  ...
  return {
    ...
    description: descriptions[slug] || "Monitor brand mentions across 12 platforms with AI-powered insights. Free tier available.",
    keywords: keywords[slug] || ["social listening", "brand monitoring"],
    openGraph: {
      title: titles[slug] || "Social Listening Tool | Kaulby",
      description: descriptions[slug] || "Monitor brand mentions across 12 platforms with AI-powered insights.",
      type: "website",
